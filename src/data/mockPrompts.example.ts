...
export const additionalMockPrompts = [
  {
    ...
    prompt:
      "Astronaut floating in deep space, Earth in background, starfield, photorealistic, cinematic lighting, 8k resolution, ultra detailed space suit",
    imageUrl:
  ...
  },
  {
    ...
    prompt:
      "Magical enchanted forest, glowing mushrooms, fairy lights, mystical atmosphere, fantasy landscape, detailed vegetation, dreamy lighting, ethereal",
    imageUrl:
  ...
  },
  {
    ...
    prompt:
      "Futuristic samurai warrior, cyberpunk armor, neon katana, Tokyo street background, rain effects, dramatic pose, highly detailed, concept art style",
    imageUrl:
      "https://images.unsplash.com/photo-1589254066213-a0c9dc853511?w=800&auto=format&fit=crop",
    author: {
      name: "Rafael Tanaka",
  ...
  },
  {
    ...
    prompt:
      "Cozy coffee shop interior, warm lighting, wooden furniture, plants, books on shelves, steam from coffee cup, afternoon sun rays, hygge aesthetic",
    imageUrl:
  ...
  },
  {
    ...
    prompt:
      "Chinese dragon flying through clouds, traditional art style, gold and red colors, detailed scales, mystical atmosphere, flowing movement, ancient mythology",
    imageUrl:
  ...
  },
  {
    ...
    prompt:
      "Underwater futuristic city, bioluminescent buildings, schools of fish, coral architecture, glass domes, ray of light from surface, sci-fi concept art",
    imageUrl:
  ...
  },
  {
    ...
    prompt:
      "Cute kawaii kitten, big eyes, pastel colors, chibi art style, fluffy fur, playful pose, anime aesthetic, adorable expression, soft lighting",
    imageUrl:
  ...
  },
  {
    ...
    prompt:
      "Victorian steampunk airship, brass and copper details, steam engines, gears and cogs, floating above clouds, vintage aesthetic, detailed mechanical parts",
    imageUrl:
